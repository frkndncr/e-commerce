        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Aliexpress Product Search</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Aliexpress</a></li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="card">
                    ...
                    <form class="forms-sample" method="POST" action="">
                        ...
                        <input type="text" name="aliexpressproduct" class="form-control" id="exampleInputUsername1" placeholder="Product Name">
                        </div>
            ...
            <table id="myDataTable" class="table table-dark">
                    ...
                    <tbody>
                        ...
                        if (!empty($liste)) {
                            ...
                            echo "<tr><td colspan='3'>Ürün bulunamadı.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
