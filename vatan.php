...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $vatanproduct = $_POST["vatanproduct"];
    $pages = $_POST["pages"]; // Kullanıcıdan kaç sayfa ürün çekmek istediğini alın
    $liste = [];
    $linkler = [];
    ...
    for ($sayfa_numarasi = 1; $sayfa_numarasi <= $pages; $sayfa_numarasi++) {
        $url = "{$baseURL}/arama/{$vatanproduct}/?page={$sayfa_numarasi}";
        ...
        // Ürün isimlerini ve fiyatlarını XPath ile çekin
        $isimler = $xpath->query("//div[contains(@class, 'product-list__product-name')]");
        $fiyatlar = $xpath->query("//span[contains(@class, 'product-list__price')]");
        
        // Ürün linklerini XPath ile çekin
        $linkNodes = $xpath->query("//a[contains(@class, 'product-list__link')]");
        
        foreach ($isimler as $i => $isimElement) {
            $isim = $isimElement->textContent;

            // XPath ile fiyatı çekin
            $fiyatNode = $fiyatlar->item($i);
            if ($fiyatNode) {
                $fiyat = trim($fiyatNode->textContent) . " TL";
            } else {
                $fiyat = "Fiyat Bulunamadı";
            }
            
            // Ürün linklerini çekin
...
<html lang="en">
  ...
  <div class="container-scroller">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Vatan Bilgisayar Product Search</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Vatan Bilgisayar</a></li>
    ...
    <div class="row justify-content-center">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" name="vatanproduct" class="form-control" id="exampleInputUsername1" placeholder="Product Name">
                        </div>
                        <div class="form-group">
        ...
        <!-- DataTables CSS ve JavaScript dosyalarını ekleyin -->
...
<body>
    ...
    <!-- DataTables için JavaScript kodu -->
    <script>
