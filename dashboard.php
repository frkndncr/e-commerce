...
function get_gbp_exchange_rate() {
  $url = 'https://api.exchangerate-api.com/v4/latest/GBP';
  $response = file_get_contents($url);
  $data = json_decode($response, true);

  $exchange_rate = $data['rates']['USD']; // USD'ye karşı GBP kurunu alır
  return $exchange_rate;
}

function get_jpy_exchange_rate() {
  $url = 'https://api.exchangerate-api.com/v4/latest/JPY';
  $response = file_get_contents($url);
  $data = json_decode($response, true);

  $exchange_rate = $data['rates']['USD']; // USD'ye karşı JPY kurunu alır
  return $exchange_rate;
}


$gbp_rate = get_gbp_exchange_rate();
$jpy_rate = get_jpy_exchange_rate();
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">$<?php echo $usd_rate ?></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">İnstant Dollar Rate</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">€<?php echo $euro_rate ?></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">İnstant Euro Rate</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">£<?php echo $gbp_rate ?></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">İnstant Pound Rate</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">¥<?php echo $jpy_rate ?></h3>
                          <p class="text-success ml-2 mb-0 font-weight-medium">+3.5%</p>
                        </div>
                      </div>
                      <div class="col-3">
                    ...
                    <h6 class="text-muted font-weight-normal">İnstant Japanese Rate</h6>
                  </div>
                </div>
              </div>
            </div>
