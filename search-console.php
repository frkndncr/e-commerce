...
require 'vendor/autoload.php'; // Google API PHP Client kitaplığını dahil ediyoruz.

// API anahtarlarını ve kimlik bilgilerini ayarlıyoruz.
$clientId = '156522109360-o8n9gbeih3g9givm4s2kf2bjblmjshu5.apps.googleusercontent.com';
$clientSecret = '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';
$redirectUri = 'http://localhost/'; // Bu, oturum açtıktan sonra kullanıcının yönlendirileceği sayfadır.
?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Search Console Register</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Search Console</a></li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="card">
                    ...
                    <p>Oturum açmak için lütfen aşağıdaki düğmeye tıklayın:</p>
                    <a href="#" id="google-login-button">Google ile Oturum Aç</a>



                    <!--YOU CAN CONTİNE FROM HERE-->
